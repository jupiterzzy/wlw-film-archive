...
// Added archive classifications.
window.WLW_GENRE_EXTRAS["Practical Magic"]=["comedy", "drama", "fantasy", "romance"];
window.WLW_GENRE_EXTRAS["Pitch Perfect"]=["comedy", "music", "romance"];
window.WLW_GENRE_EXTRAS["Pitch Perfect 2"]=["comedy", "music"];
window.WLW_GENRE_EXTRAS["Pitch Perfect 3"]=["comedy", "music"];
window.WLW_GENRE_EXTRAS["Mean Girls"]=["comedy", "music"];
window.WLW_GENRE_EXTRAS["Wicked"]=["drama", "fantasy", "music", "romance"];
window.WLW_GENRE_EXTRAS["Wicked: For Good"]=["drama", "fantasy", "music", "romance"];
window.WLW_GENRE_EXTRAS["Notes on a Scandal"]=["drama"];
window.WLW_GENRE_EXTRAS["What Keeps You Alive"]=["horror", "thriller"];
window.WLW_GENRE_EXTRAS["Tully"]=["comedy", "drama"];
window.WLW_GENRE_EXTRAS["Thoroughbreds"]=["crime", "drama", "thriller"];
window.WLW_GENRE_EXTRAS["The Novice"]=["drama", "thriller"];
window.WLW_GENRE_EXTRAS["That's Not Us"]=["comedy", "drama", "romance"];
window.WLW_GENRE_EXTRAS["Only the Animals"]=["crime", "drama", "mystery", "thriller"];
window.WLW_GENRE_EXTRAS["Lizzie"]=["crime", "drama", "history", "romance", "thriller"];
window.WLW_GENRE_EXTRAS["Hearts Beat Loud"]=["comedy", "drama", "music"];
window.WLW_GENRE_EXTRAS["Be with Me"]=["drama", "romance"];
window.WLW_GENRE_EXTRAS["Babylon"]=["comedy", "drama", "history"];
window.WLW_GENRE_EXTRAS["Aniara"]=["drama", "science-fiction"];
window.WLW_GENRE_EXTRAS["Black Swan"]=["drama", "horror", "thriller"];
window.WLW_GENRE_EXTRAS["Little Trouble Girls"]=["drama"];
