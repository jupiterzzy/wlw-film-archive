...
function renderAlphabet(){
  ...
  alphabet.forEach(letter=>{const link=document.createElement("a");link.className=`letter-button${letter===currentLetter?" active":""}`;link.href=letter==="A"?"./index.html":`./index.html?letter=${letter}`;link.textContent=letter;if(letter===currentLetter)link.setAttribute("aria-current","page");track.appendChild(link);});
